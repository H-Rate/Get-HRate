    ...
    <div className="Terms-main">
      <div className="Terms-content">
        ...
        <p>
          ...
          not continue to use HRate if you do not agree to take all of the terms
        ...
        <p>
          Unless otherwise stated, HRate and/or its licensors own the
          intellectual property rights for all material on HRate. All
          intellectual property rights are reserved. You may access this from
          HRate for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from HRate</li>
          <li>Sell, rent or sub-license material from HRate</li>
          <li>Reproduce, duplicate or copy material from HRate</li>
          <li>Redistribute content from HRate</li>
        </ul>
        ...
        <p>
          ...
          opinions and information in certain areas of the website. HRate does
          ...
          HRate, its agents and/or affiliates. Comments reflect the views and
          opinions of the person who post their views and opinions. To the
          extent permitted by applicable laws, HRate shall not be liable for the
        ...
        <p>
          HRate reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant HRate a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of HRate; and (d) the link is in
        ...
        <p>
          ...
          e-mail to HRate. Please include your name, your organization name,
        ...
        <p>
          No use of HRate's logo or other artwork will be allowed for linking
